...
export class UniversityComponent implements OnInit {
  ...
  constructor( public service: UniversityService,
    ...
    public dialogRef: MatDialogRef<UniversityComponent> ) { }

  careers = [
    { id: "IMTC", value: "Mechatronics" },
    { id: "IB", value: "Biomedical" },
    { id: "Both", value: "Both" }
  ];
  ...
  onSubmit() {
    if (this.service.form.valid) {
      if (!this.service.form.get('$key').value) 
        this.service.addUniversity(this.service.form.value)
      else 
        this.service.updateUniversity(this.service.form.value);
      this.service.form.reset();
      this.service.initializeFormGroup();
